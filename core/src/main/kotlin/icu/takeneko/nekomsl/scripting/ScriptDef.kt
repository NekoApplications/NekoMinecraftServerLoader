...
import icu.takeneko.nekomsl.minecraft.MinecraftConfigurationHandlerScope
...
object ScriptConfiguration : ScriptCompilationConfiguration({
    ...
    defaultImports("icu.takeneko.nekomsl.minecraft.mod.*")
    defaultImports("icu.takeneko.nekomsl.minecraft.mod.loader.*")
    defaultImports("icu.takeneko.nekomsl.minecraft.mod.repo.*")
    defaultImports(
        "java.io.*",
        "java.nio.*",
        "java.nio.charset.*",
